            ...
            <section class="card">
                <form class="card-body">
                    <div class="my-2">
                        ...
                        <input id="id" value="${ post.id }" readonly />
                    </div>
                    <div class="my-2">
                    ...
                    <div class="my-2">
                        <label class="form-lable" for="author">작성자
                            아이디</label> <input class="form-control" id="author"
                            value="${ post.author }" readonly />
                    </div>
                    <div class="my-2">
                        <label class="form-lable" for="createdTime">작성시간</label>
                    ...
                    <div class="my-2">
                        <label class="form-lable" for="modifiedTime">수정시간</label>
