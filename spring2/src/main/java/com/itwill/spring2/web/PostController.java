...
public class PostController {
    ...
    public void list(Model model) {
        ...
        //리턴값이 없는 경우 뷰의 이름은 요청 주소와 같음.
        // /WEB-INF/views/post/list.jsp
    }
    
    @GetMapping("/create")
    public void create() {
        log.info("GET: create()"); //DB까지 갈일이 없으니까
    }
    
    @PostMapping("/create") //DB까지 가야됨
    ...
    @GetMapping("/detail") //클래스에 post라는 맵핑이있어서 post하위 주소만 쓰면 됨
    ...
    public String update(PostUpdateDto dto) {
        ...
        return "redirect:/post/list"; 
        //상세보기로 가기: "redirect:/post/detail?id=" + dto.getId() -> 쓰려면 PostUpdateDto에 @getter 필요함
    }
